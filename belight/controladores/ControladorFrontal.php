<?php
	...
	$controllers= array(
						...
						'Usuarios'=>['cerrarSesion','index','registrar','actualizarUsuario','listarUsuarios','listarUsuarioId','modificarUsuario','darseBajaUsuario','crearUsuario','login','loguearse','bajaVista'],
                                                ...
                                                'Pedidos'=>['guardarPedido','eliminarPedido','eliminarPedidoAdmin','actualizarPedido','confirmarPedido','listarPedidos','listarPedidosAdmin','buscarPedidos','confirmarEliminarPedido'],
